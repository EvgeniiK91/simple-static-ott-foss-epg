...
LATEST_RELEASE=`curl -s https://api.github.com/repos/prog4food/ott-play-epg-converter/releases/latest | sed -nE 's/"browser_download_url": "([^"]+)"/\1/p' | grep "ofoss-epg-conv_linux_x64\.gz$"`
